...
const pulseItems = [
  ...
  { label: 'Messages scheduled', value: 32, detail: 'Communication Center', icon: BellRing, href: '/communication', tone: 'teal' },
  { label: 'Renewal alerts', value: 12, detail: 'Memberships & packages', icon: RefreshCw, href: '/memberships', tone: 'gold' },
  { label: 'Follow-ups due', value: 8, detail: 'Customer retention', icon: Clock3, href: '/communication', tone: 'teal' },
]
